                    ...
                    try:
                        ...
                        if aud:
                            ...
                            if sess.buf_count%8==7 and sess.current_audio_state == "start":
                                await interrupt_output(sess, reason="stt_slice")
...
async def interrupt_output(sess: Session, reason: str = "user_speaking"):
